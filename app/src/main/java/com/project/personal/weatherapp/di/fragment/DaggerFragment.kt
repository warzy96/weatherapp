...
abstract class DaggerFragment : android.support.v4.app.Fragment() {
    ...
    var fragmentComponent: FragmentComponent? = null
        get() {
            fragmentComponent?.let {
                ...
                return ComponentFactory.createFragmentComponent(this, getDaggerActivity()?.getActivityComponent())
            }
        }
